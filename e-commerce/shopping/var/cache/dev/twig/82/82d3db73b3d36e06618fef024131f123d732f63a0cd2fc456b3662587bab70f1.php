...
class __TwigTemplate_32e7f24737f003adb2518beb9bcb0a4994c05dac1795d2b7338b749da269a433 extends \Twig\Template
{
...
";
    ...
    ";
        // line 31
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock(($context["generateByDateForm"] ?? $this->getContext($context, "generateByDateForm")), 'form_start', ["method" => "POST", "action" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_order_invoices_generate_by_date")]);
        echo "
    <div class=\"card\">
...
{% block invoices_generate_by_date %}
  <div class=\"col-xl-10\">
    ...
    <div class=\"card\">
      ...
      <div class=\"card-footer\">
        <div class=\"d-flex justify-content-end\">
          <button class=\"btn btn-primary\">{{ 'Generate PDF file by date'|trans }}</button>
        </div>
      </div>
    </div>
...
{% endblock %}
", "@PrestaShop/Admin/Sell/Order/Invoices/Blocks/generate_by_date.html.twig", "/home/u644237725/domains/lulitojeans.com/public_html/shopping/src/PrestaShopBundle/Resources/views/Admin/Sell/Order/Invoices/Blocks/generate_by_date.html.twig");
    }
}
