...
class __TwigTemplate_6cb8097550240b6d8d3121e5ffff855862b3a3d7b41b1fe6a90e8af29a12f6f8 extends \Twig\Template
{
...
";
    ...
    public function block_invoices_generate_by_status($context, array $blocks = [])
    {
        ...
        ";
        // line 33
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock(($context["generateByStatusForm"] ?? $this->getContext($context, "generateByStatusForm")), 'form_start', ["method" => "POST", "action" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_order_invoices_generate_by_status")]);
        echo "
        <div class=\"card\">
...
";
    ...
    {
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e = $this->env->getExtension("Symfony\\Bundle\\WebProfilerBundle\\Twig\\WebProfilerExtension");
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "block", "_form_generate_by_status_order_states_entry_label"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "block", "_form_generate_by_status_order_states_entry_label"));
...
{% block invoices_generate_by_status %}
    <div id=\"by-status-block\" class=\"col-xl-10\">
        ...
        <div class=\"card\">
            ...
            <div class=\"card-footer\">
                <div class=\"d-flex justify-content-end\">
                    <button class=\"btn btn-primary\">{{ 'Generate PDF file by status'|trans }}</button>
                </div>
            </div>
        </div>
...
{% block _form_generate_by_status_order_states_entry_label %}
    ...
    {% endif %}
{% endblock %}
", "@PrestaShop/Admin/Sell/Order/Invoices/Blocks/generate_by_status.html.twig", "/home/u644237725/domains/lulitojeans.com/public_html/shopping/src/PrestaShopBundle/Resources/views/Admin/Sell/Order/Invoices/Blocks/generate_by_status.html.twig");
    }
}
